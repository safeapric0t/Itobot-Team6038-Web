      ...
      <div className="relative mx-auto w-full max-w-5xl px-5 md:px-8">
        <article className="glass-panel rounded-3xl p-8 md:p-12">
          ...
          <p className="mt-5 max-w-2xl text-sm leading-relaxed text-slate-300 md:text-base">
            Team Gallery Writing in progress. This page will feature a dynamic gallery of team photos, event highlights, and memorable moments from the season, all presented in an engaging and visually appealing format that captures the spirit of Team Wing. Stay tuned for updates as we curate and design this exciting new section of our website!
          </p>
        </article>
      </div>
    </section>
